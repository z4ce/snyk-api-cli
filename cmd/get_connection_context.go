...
func runGetConnectionContext(cmd *cobra.Command, args []string) error {
	...
	if getConnectionContextVerbose {
	...
	} else if getConnectionContextVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", getConnectionContextUserAgent)
	...
	return handleGetConnectionContextResponse(resp, getConnectionContextIncludeResp, getConnectionContextVerbose, getConnectionContextSilent)
}
...
func handleGetConnectionContextResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
