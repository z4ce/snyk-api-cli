...
func runDeleteBrokerConnection(cmd *cobra.Command, args []string) error {
	...
	if deleteBrokerConnectionVerbose {
	...
	} else if deleteBrokerConnectionVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", deleteBrokerConnectionUserAgent)
	...
	return handleDeleteBrokerConnectionResponse(resp, deleteBrokerConnectionIncludeResp, deleteBrokerConnectionVerbose, deleteBrokerConnectionSilent)
}
...
func handleDeleteBrokerConnectionResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
