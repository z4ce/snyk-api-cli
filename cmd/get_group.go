...
func runGetGroup(cmd *cobra.Command, args []string) error {
	...
	} else if getGroupVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", getGroupUserAgent)
	...
	return handleGetGroupResponse(resp, getGroupIncludeResp, getGroupVerbose, getGroupSilent)
}
...
func handleGetGroupResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
