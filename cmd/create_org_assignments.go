...
func runCreateOrgAssignments(cmd *cobra.Command, args []string) error {
	...
	if createOrgAssignmentsVerbose {
	...
	} else if createOrgAssignmentsVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", createOrgAssignmentsUserAgent)
	...
	return handleCreateOrgAssignmentsResponse(resp, createOrgAssignmentsIncludeResp, createOrgAssignmentsVerbose, createOrgAssignmentsSilent)
}
...
func handleCreateOrgAssignmentsResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
