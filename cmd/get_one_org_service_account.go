...
func runGetOneOrgServiceAccount(cmd *cobra.Command, args []string) error {
	...
	if getOneOrgServiceAccountVerbose {
	...
	} else if getOneOrgServiceAccountVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", getOneOrgServiceAccountUserAgent)
	...
	return handleGetOneOrgServiceAccountResponse(resp, getOneOrgServiceAccountIncludeResp, getOneOrgServiceAccountVerbose, getOneOrgServiceAccountSilent)
}
...
func handleGetOneOrgServiceAccountResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
