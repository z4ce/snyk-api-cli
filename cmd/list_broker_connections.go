...
func runListBrokerConnections(cmd *cobra.Command, args []string) error {
	...
	if listBrokerConnectionsVerbose {
	...
	} else if listBrokerConnectionsVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", listBrokerConnectionsUserAgent)
	...
	return handleListBrokerConnectionsResponse(resp, listBrokerConnectionsIncludeResp, listBrokerConnectionsVerbose, listBrokerConnectionsSilent)
}
...
func handleListBrokerConnectionsResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
