...
func runGetSlackDefaultNotificationSettings(cmd *cobra.Command, args []string) error {
	...
	if getSlackDefaultNotificationSettingsVerbose {
	...
	} else if getSlackDefaultNotificationSettingsVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", getSlackDefaultNotificationSettingsUserAgent)
	...
	return handleGetSlackDefaultNotificationSettingsResponse(resp, getSlackDefaultNotificationSettingsIncludeResp, getSlackDefaultNotificationSettingsVerbose, getSlackDefaultNotificationSettingsSilent)
}
...
func handleGetSlackDefaultNotificationSettingsResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
