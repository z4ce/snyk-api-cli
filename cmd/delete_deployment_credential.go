...
func runDeleteDeploymentCredential(cmd *cobra.Command, args []string) error {
	...
	if deleteDeploymentCredentialVerbose {
	...
	} else if deleteDeploymentCredentialVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", deleteDeploymentCredentialUserAgent)
	...
	return handleDeleteDeploymentCredentialResponse(resp, deleteDeploymentCredentialIncludeResp, deleteDeploymentCredentialVerbose, deleteDeploymentCredentialSilent)
}
...
func handleDeleteDeploymentCredentialResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
