...
func runCreateBrokerDeployment(cmd *cobra.Command, args []string) error {
	...
	if createBrokerDeploymentVerbose {
		fmt.Fprintf(os.Stderr, "* Requesting POST %s\n", fullURL)
	}

	// Create the HTTP request
	var body io.Reader
	if createBrokerDeploymentData != "" {
		body = strings.NewReader(createBrokerDeploymentData)
	}
	...
	} else if createBrokerDeploymentVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", createBrokerDeploymentUserAgent)
	...
	return handleCreateBrokerDeploymentResponse(resp, createBrokerDeploymentIncludeResp, createBrokerDeploymentVerbose, createBrokerDeploymentSilent)
}
...
func handleCreateBrokerDeploymentResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
