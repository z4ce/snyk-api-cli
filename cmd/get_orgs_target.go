...
func runGetOrgsTarget(cmd *cobra.Command, args []string) error {
	...
	} else if getOrgsTargetVerbose {
		fmt.Fprintf(os.Stderr, "* No automatic authorization available\n")
	}

	// Set user agent
	req.Header.Set("User-Agent", getOrgsTargetUserAgent)
	...
	return handleGetOrgsTargetResponse(resp, getOrgsTargetIncludeResp, getOrgsTargetVerbose, getOrgsTargetSilent)
}
...
func handleGetOrgsTargetResponse(resp *http.Response, includeResp, verbose, silent bool) error {
	if verbose {
